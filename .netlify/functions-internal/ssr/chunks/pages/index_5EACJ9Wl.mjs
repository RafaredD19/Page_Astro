...
const $$Intro = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Intro;
  return renderTemplate`${maybeRenderHead()}<section class="px-4 my-14"> <img class="rounded-none lg:rounded-full xl:rounded-full md:rounded-full size-40  lg:float-end my-10 border border-1 border-white animate-wiggle animate-infinite" src="../../public/img/perfil.png" alt="Rafael Rossel Galarza"> <h1 class="text-white text-3xl md:text-4xl lg:text-5xl font-bold ">
